...
| **[`mcu_balance_fusion_wireless`](file:///c:/Users/vilas/Documents/PlatformIO/Projects/self%20balancing%20Bipedal%20robot/Balancing_Bipedal_Firmware_and_Scripts/Balance_Rework/tuner_legcontrol/mcu_balance_fusion_wireless)** | **MCU (STM32)** | Wireless (3DR) | 115,200 | Disabled | **[STAGE 2, in progress] Sensor-fusion balancer.** Forked from `mcu_ik_engine_pretest_wireless` (tag `pretest-wireless-single-loop-v1`); same validated leg bus and telemetry, adding fused pitch/velocity estimation (encoder + IMU) on top. |
