...
| **[`mcu_ik_engine_pretest_wireless`](file:///c:/Users/vilas/Documents/PlatformIO/Projects/self%20balancing%20Bipedal%20robot/Balancing_Bipedal_Firmware_and_Scripts/Balance_Rework/tuner_legcontrol/mcu_ik_engine_pretest_wireless)** | None (single PID) | Wireless 3DR (`Serial3`) | 115,200 | Disabled | **Minimal single-loop balancer.** One balance PID + IMU calibration, single-screen GUI; retains a PING/PONG latency probe for `latency_test.py`. |
...
| **[`mcu_pos_wireless`](file:///c:/Users/vilas/Documents/PlatformIO/Projects/self%20balancing%20Bipedal%20robot/Balancing_Bipedal_Firmware_and_Scripts/Balance_Rework/tuner_legcontrol/mcu_pos_wireless)** | **MCU (STM32)** | Wireless 3DR (`Serial3`) | 115,200 | Disabled | **Position / encoder-target tuner.** Dedicated single-position balancing and encoder hold-position tuning. |
