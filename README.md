...
**🎥 Demo video:** PAW balancing and moving under its own control loop.

https://github.com/user-attachments/assets/27b52d88-99b3-40d9-a2d7-85beb14acbb2

*(A raw copy of this clip is also kept in-repo at [`media/paw_demo.mp4`](media/paw_demo.mp4).)*
...
* **[`tuner_legcontrol/`](file:///c:/Users/vilas/Documents/PlatformIO/Projects/self%20balancing%20Bipedal%20robot/Balancing_Bipedal_Firmware_and_Scripts/Balance_Rework/tuner_legcontrol)**: Unified leg control and balance tuning suite featuring 6 project subfolders:
  ...
  * **[`mcu_ik_engine_pretest_wireless`](file:///c:/Users/vilas/Documents/PlatformIO/Projects/self%20balancing%20Bipedal%20robot/Balancing_Bipedal_Firmware_and_Scripts/Balance_Rework/tuner_legcontrol/mcu_ik_engine_pretest_wireless)**: Minimal single-loop wireless balancer (one balance PID + calibration, single-screen GUI); retains a PING/PONG latency probe (`latency_test.py`).
